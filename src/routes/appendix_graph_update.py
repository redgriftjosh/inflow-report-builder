...
def generate_graph(df, graph_id, dev, kw_period, acfm_period, pressure_period):
    ...
    url = f"https://inflow-co.bubbleapps.io{dev}/api/1.1/obj/appendix_graph/{graph_id}"
...
def start():
    ...
    day_end = appendix_graph_json.get('response').get('day_end')
    time_start = appendix_graph_json.get('response').get('time_start')
    time_end = appendix_graph_json.get('response').get('time_end')
    kw_period = appendix_graph_json.get('response').get('kw_period')
    acfm_period = appendix_graph_json.get('response').get('acfm_period')
    pressure_period = appendix_graph_json.get('response').get('pressure_period')
    report_id = appendix_graph_json.get('response').get('report')
    ...
    generate_graph(df, graph_id, dev, kw_period, acfm_period, pressure_period)
