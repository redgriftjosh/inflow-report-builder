...
import os
from utilities import baseline_proposed_7_1_util, requests_util
...
def get_scenario_demand_schedule_id(report_id, scenario_id, dev):
    ...
    report_demand_schedule_json = requests_util.get_req("operation_period", report_demand_schedule_id, dev)
