...
def start():
    ...
    # print('')
    try:
        scenario_json = clean_json(scenario_json, processed_ids)
    ...
    try:
        things_json = find_ids(scenario_json) # returns the report_json but only with thing ids e.g. {'air_compressors': ['12398467x219083473243224', '10843759387x0293481029374021'], 'trim': '098732490873x298374210398701'}
