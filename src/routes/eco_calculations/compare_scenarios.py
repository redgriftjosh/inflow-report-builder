...
def get_proposed_things(scenario_json, report_id, dev):
    ...
    return avg_kws, total_kwh_annual
...
def start():
    ...
    proposed_avg_kw, proposed_kwh_annual = get_proposed_things(scenario_json, report_id, dev)
    baseline_avg_kw, baseline_kwh_annual = get_baseline_things(scenario_json, report_id, dev)
