...
def get_total_proposed_drain_cfm(scenario_id, dev):
    ...
    drain_ids = scenario_proposed_json["response"]["drain"]
    ...
    total_proposed_drain_cfm = sum(adjusted_cfms)

    return total_proposed_drain_cfm
...
def start():
    ...
    total_proposed_drain_cfm = get_total_proposed_drain_cfm(scenario_id, dev)
    total_report_drain_cfm = get_total_report_drain_cfm(report_id, dev)

    total_drain_cfm = total_proposed_drain_cfm - total_report_drain_cfm
